<?php //b8afe5dc19a0e49c782277bb5295bce7
/** @noinspection all */
...
namespace LaravelIdea\Helper\Illuminate\Notifications {
     ...
     * @method DatabaseNotification|null first(array|string $columns = ['*'])
     ...
     * @method DatabaseNotification|null firstWhere(array|\Closure|Expression|string $column, $operator = null, $value = null, string $boolean = 'and')
