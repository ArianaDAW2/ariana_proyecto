<?php //6e8ac8adb49430eee7eb278588c09e36
/** @noinspection all */
...
namespace Laravel\Sanctum {
     ...
     * @method static _IH_PersonalAccessToken_QB on(null|string|\UnitEnum $connection = null)
     ...
     * @method static _IH_PersonalAccessToken_C|PersonalAccessToken[] all($columns = ['*'])
