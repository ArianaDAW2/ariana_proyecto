...
<?php $component->withAttributes([]); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reservations[0] == null): ?>
        {
        ...
        <table class="text-center mx-auto">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="grid grid-cols-6">
                    ...
                    <td><?php echo e($reservation->start_date->format('d/m/Y')); ?></td>
                    <td><?php echo e($reservation->end_date->format('d/m/Y')); ?></td>
...
<?php $component->withAttributes(['align' => 'left','width' => '48']); ?>
                             <?php $__env->slot('trigger', null, []); ?> 
                                <button class="px-3 py-1 bg-gray-200 rounded-md hover:bg-gray-300">
                                    Ver servicios (<?php echo e($reservation->services->count()); ?>)
                                </button>
                             <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/proyectos/ariana_proyecto/resources/views/client/my_reservations.blade.php ENDPATH**/ ?>