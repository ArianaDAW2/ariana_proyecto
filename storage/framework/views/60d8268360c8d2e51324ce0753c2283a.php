...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['style' => session('flash.bannerStyle', 'success'), 'extra' => session('flash.banner')]));
...
foreach (array_filter((['style' => session('flash.bannerStyle', 'success'), 'extra' => session('flash.banner')]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="<?php echo e(json_encode(['show' => true, 'style' => $style, 'extra' => $extra])); ?>"
...
<?php /**PATH /opt/lampp/htdocs/proyectos/ariana_proyecto/resources/views/components/banner.blade.php ENDPATH**/ ?>