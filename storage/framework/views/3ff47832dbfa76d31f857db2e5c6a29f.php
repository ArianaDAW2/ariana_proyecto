                ...
                <table class="w-full text-left">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3"><?php echo e($payment->id); ?></td>
                            <td class="px-4 py-3"><?php echo e(number_format($payment->amount, 2)); ?>€</td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3"><?php echo e($payment->paid_at?->format('d/m/Y') ?? 'Pendiente'); ?></td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/proyectos/ariana_proyecto/resources/views/admin/payments.blade.php ENDPATH**/ ?>