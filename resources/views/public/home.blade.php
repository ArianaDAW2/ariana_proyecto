<x-guest-layout>
    ...
    @section('content-1')
        <section>
            ...
            <h2 class="text-purple-500 font-bold pb-3 text-[20px] italic">CURAMOS CON EL CONOCIMIENTO<br> CUIDAMOS CON
                EL
                CORAZÓN</h2>
            <div class="text-gray-800">
                <p class="p-2 ">En el cuidado y la atención de cada uno de nuestros pacientes se unen el <span
                        class="font-bold"> respeto, el cariño y la profesionalidad</span> como base de nuestra
                    filosofía.
                <p>
                <p class="p-2 ">Cada uno de nuestros peluditos se trata de forma individualizada y especial. Tal y como
                    reza
                    nuestro
                    lema: ''Curamos con el conocimiento, cuidamos con el corazón''.</p>
                <p class="p-2 ">Para poder ofrecer el mejor servicio confiamos en la formación continuada de nuestro
                    equipo
                    de
