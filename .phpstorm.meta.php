...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./opt/lampp/htdocs/proyectos/ariana_proyecto/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./opt/lampp/htdocs/proyectos/ariana_proyecto/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'scribe.postman.enabled','scribe.postman.overrides','scribe.openapi.enabled','scribe.openapi.version','scribe.openapi.overrides',
...
'scribe','scribe.postman','scribe.openapi','login','login.store',
...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','profile.show',
'api-tokens.index','sanctum.csrf-cookie','livewire.update',
'livewire.upload-file','livewire.preview-file','invoices.index','invoices.store','invoices.show',
'invoices.update','invoices.destroy','medical-records.index','medical-records.store','medical-records.show',
'medical-records.update','medical-records.destroy','reservations.index','reservations.store','reservations.show',
'reservations.update','reservations.destroy','services.index','services.store','services.show',
'services.update','services.destroy','pets.index','pets.store','pets.show',
'pets.update','pets.destroy','users.index','users.store','users.show',
'users.update','users.destroy','public.home','public.services',
'public.gallery','document.contact','document.contact.send','document.admin.extra.create','document.admin.message',
'document.print.invoices','client.dashboard','client.my_reservations','client.top_buyers','client.top_services',
'admin.users','admin.services','admin.reservations','admin.medical-records','admin.pets',
'admin.invoices','admin.panel-admin','admin.payments','home',
'services','gallery','storage.local',);
        registerArgumentsSet('views', 
'admin.extra.create','admin.invoices','admin.medical-records','admin.payments','admin.pets',
'admin.reservations','admin.services','admin.users','api.api-token-manager','api.index',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.two-factor-challenge','auth.verify-email','client.my_reservations','client.top_buyers','client.top_services',
...
'components.confirms-password','components.danger-button','components.date-picker','components.dialog-modal','components.dropdown',
...
'dashboard','emails.admin-message','emails.contact-form','emails.reservation-created','emails.reservation-reminder',
'emails.team-invitation','emails.user-registered','layouts.app','layouts.footer','layouts.guest',
'layouts.nav','livewire.invoices-crud','livewire.language-switcher','livewire.medical-records-crud','livewire.pets-crud',
'livewire.reservations-crud','livewire.services-crud','livewire.users-crud','navigation-menu','panel',
'pdf.invoices','pdf.reservation','policy','profile.delete-user-form','profile.logout-other-browser-sessions-form',
'profile.show','profile.two-factor-authentication-form','profile.update-password-form','profile.update-profile-information-form','public.contact',
'public.gallery','public.home','public.services','scribe.index','terms',
...
'validation.custom.attribute-name.rule-name','auth.pass','auth.delete_account','auth.delete_account_desc','auth.delete_account_warning',
'auth.delete_account_confirm','auth.passwd','auth.cancel','auth.browser_sessions','auth.browser_sessions_desc',
'auth.browser_sessions_warning','auth.unknown','auth.this_device','auth.last_active','auth.logout_other_sessions',
'auth.done','auth.logout_other_sessions_confirm','auth.email','auth.remember_me','auth.forgot_password',
'auth.log_in','auth.name','auth.confirm_password','auth.agree_terms','auth.terms_of_service',
'auth.privacy_policy','auth.already_registered','auth.register','auth.profile','auth.two_factor_auth',
'auth.two_factor_auth_desc','auth.two_factor_finish_enabling','auth.two_factor_enabled','auth.two_factor_not_enabled','auth.two_factor_explanation',
'auth.two_factor_scan_qr_finish','auth.two_factor_scan_qr','auth.setup_key','auth.code','auth.recovery_codes_warning',
'auth.enable','auth.regenerate_recovery_codes','auth.confirm','auth.show_recovery_codes','auth.disable',
'auth.update_password','auth.update_password_desc','auth.current_password','auth.new_password','auth.saved',
'auth.save','auth.profile_information','auth.profile_information_desc','auth.photo','auth.select_new_photo',
'auth.remove_photo','auth.email_unverified','auth.resend_verification','auth.verification_link_sent','private.global_message',
'private.reservation','private.invoice_number','private.total','private.unpaid','private.paid',
'private.update','private.create_invoice','private.invoice','private.status','private.date',
'private.actions','private.edit','private.delete','private.pet','private.veterinarian',
'private.diagnosis','private.treatment','private.notes','private.create_record','private.owner',
'private.name','private.species','private.breed','private.age','private.weight',
'private.create_pet','private.all_species','private.sort_alphabetically','private.min_weight','private.max_weight',
'private.client','private.start_date','private.end_date','private.pending','private.confirmed',
'private.completed','private.cancelled','private.total_price','private.create_reservation','private.service_name',
'private.description','private.base_price','private.active','private.create_service','private.yes',
'private.no','private.email','private.password','private.create','private.dashboard',
'private.services','private.control_panel','private.manage_account','private.profile','private.api_tokens',
'private.log_out','private.manage_team','private.team_settings','private.create_new_team','private.switch_teams',
'private.admin_panel','private.users','private.pets','private.reservations','private.medical_records',
'private.invoices','private.payments','private.welcome','private.users_desc','private.pets_desc',
'private.reservations_desc','private.medical_records_desc','private.services_desc','private.invoices_desc','private.go_to_users',
'private.go_to_pets','private.go_to_reservations','private.go_to_medical_records','private.go_to_services','private.go_to_invoices',
'public.welcome','public.slogan_1','public.slogan_2','public.intro_1','public.intro_values',
'public.intro_2','public.intro_3','public.intro_4','public.intro_5','public.services_treatments',
'public.intro_6','public.care_anytime','public.view_gallery','public.missing_image','public.discover_services',
'public.services_link','public.service_image','public.services','public.inactive_services','public.name',
'public.description','public.base_price','public.unknown','public.active','public.inactive',
'public.gallery','public.explore_images','public.contact','public.email','public.extra',
'public.your_title','public.your_email','public.your_message','public.send','public.dashboard',
'public.login','public.register','public.book_appointment','public.contact_us','public.care_24h',
'public.all_rights','public.back_to_top','public.menu','public.home','public.veterinarians',
'public.accommodation','public.games','public.grooming','public.consultation','public.training',
'public.coming_soon','public.surgery','public.photo_session','public.aromatherapy','public.emergency_24h',
'public.dentist','public.title','public.message_sent','private.private.Delete_Account',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','SCRIBE_AUTH_KEY',
